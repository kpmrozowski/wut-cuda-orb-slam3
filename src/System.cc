    ...
    mbShutDown(false)
{
    ...
    cout << endl
         << "ORB-SLAM3 Copyright (C) 2017-2020 Carlos Campos, Richard Elvira, Juan J. Gómez, José M.M. "
    ...
    if (mpLocalMapper->mThFarPoints != 0) {
        cout << "Discard points further than " << mpLocalMapper->mThFarPoints << " m from current camera"
             << endl;
                                 ...
                                 const vector<IMU::Point> &vImuMeas, string filename)
{
    ...
    Sophus::SE3f Tcw = orb::benchmark::measure_function(orb::benchmark::MeasuredFunction::GrabImageStereo,
                                                        &Tracking::GrabImageStereo, mpTracker, imLeftToFeed,
                                                        imRightToFeed, timestamp, filename);
